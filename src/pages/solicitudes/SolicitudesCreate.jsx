                ...
                <div className='space-y-4'>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className={`w-full p-2 border rounded-lg ${errors.id_convenio ? 'border-red-500' : 'border-gray-300'}`}
                      disabled={loadingConvenios}
                    >
                      <option value=''>Seleccione un convenio</option>
                      {convenios.map(convenio => (
                        <option key={convenio._id} value={convenio._id}>
                          {convenio.nombre_institucion} ({convenio.pais_institucion}) - Cupos: {convenio.cupos_disponibles}
                        </option>
                      ))}
                    </select>
                  ...
                  <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                    <div>
                      ...
                      <select
                        ...
                        onChange={handleChange}
                        className={`w-full p-2 border rounded-lg ${errors.periodo_academico ? 'border-red-500' : 'border-gray-300'}`}
                      >
                      ...
                      {errors.periodo_academico && <p className='text-red-500 text-xs mt-1'>{errors.periodo_academico}</p>}
                    </div>
                  ...
                  <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        min='1'
                        max='2'
                        className={`w-full p-2 border rounded-lg ${errors.duracion ? 'border-red-500' : 'border-gray-300'}`}
                      />
                        ...
                        <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                          <div>
                            ...
                            <input
                              ...
                              className={`w-full p-2 border rounded-lg ${errors[`asignatura_${index}_codigo_origen`] ? 'border-red-500' : 'border-gray-300'}`}
                              placeholder='IS-4501'
                            />
                          ...
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) => handleAsignaturaChange(index, e)}
                              className={`w-full p-2 border rounded-lg ${errors[`asignatura_${index}_nombre_origen`] ? 'border-red-500' : 'border-gray-300'}`}
                        ...
                        <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) => handleAsignaturaChange(index, e)}
                              className={`w-full p-2 border rounded-lg ${errors[`asignatura_${index}_codigo_destino`] ? 'border-red-500' : 'border-gray-300'}`}
                              placeholder='IA-3420'
                            />
                            {errors[`asignatura_${index}_codigo_destino`] && (
                              <p className='text-red-500 text-xs mt-1'>{errors[`asignatura_${index}_codigo_destino`]}</p>
                            )}
                          </div>
