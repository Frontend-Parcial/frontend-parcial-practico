    ...
    return (
      <div className='h-full flex items-center justify-center'>
        <div className='text-center text-red-600'>
          ...
          <p className='text-xs mt-2 text-gray-500'>Revisa la consola para más detalles</p>
        </div>
      </div>
    )
  }
    ...
    <div className='h-full'>
      ...
      <ResponsiveContainer width='100%' height={isExpanded ? 400 : 150}>
        <BarChart data={data} layout='vertical' margin={{ top: 5, right: 30, left: 80, bottom: 5 }}>
          ...
          <YAxis type='category' dataKey='pais' width={70} fontSize={12} />
          <Tooltip
            formatter={(value, name) => [`${value} convenio${value !== 1 ? 's' : ''}`, 'Cantidad']}
