...
export async function getTipoConvenio(año = null) {
  ...
  try {
    ...
    const url = año ? `${apiURL}/reportes/estadisticas/tipo?año=${año}` : `${apiURL}/reportes/estadisticas/tipo`
    ...
    throw new Error(error.message || 'Error desconocido al obtener datos de tipo de convenio')
  }
}
